...
const DESCRIPTORS: &[BackendDescriptor] = &[
    ...
    BackendDescriptor {
        id: SWAY_BACKEND,
        failure_label: "Sway",
        list_note: "Window list came from swaymsg. Terminal windows may include best-effort PTY and active-process context when xprop and the process tree are readable.",
        missing_hint: "On Sway/wlroots, ensure swaymsg can reach the active sway IPC socket (SWAYSOCK).",
        can_exact_focus: true,
    },
    BackendDescriptor {
        id: I3_BACKEND,
